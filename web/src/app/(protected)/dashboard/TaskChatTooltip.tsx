            ...
            {notesExpanded && (
              <div className="px-4 pb-3 sm:px-6">
                <div className="max-h-[50vh] overflow-y-auto">
                  <div className="max-w-none text-sm text-violet-200 [&>*+*]:mt-3 [&_h1]:mt-5 [&_h1]:mb-2 [&_h1]:text-base [&_h1]:font-bold [&_h1]:text-white [&_h2]:mt-4 [&_h2]:mb-2 [&_h2]:text-sm [&_h2]:font-bold [&_h2]:text-white [&_h3]:mt-3 [&_h3]:mb-1.5 [&_h3]:text-sm [&_h3]:font-semibold [&_h3]:text-violet-200 [&_p]:leading-relaxed [&_ul]:ml-4 [&_ul]:list-disc [&_ul]:space-y-1 [&_ol]:ml-4 [&_ol]:list-decimal [&_ol]:space-y-1 [&_li]:text-violet-200 [&_a]:text-violet-400 [&_a]:underline [&_hr]:my-4 [&_hr]:border-white/10 [&_strong]:text-white [&_code]:text-amber-300 [&_code]:bg-white/5 [&_code]:rounded [&_code]:px-1 [&_blockquote]:border-l-2 [&_blockquote]:border-violet-500/30 [&_blockquote]:pl-3 [&_blockquote]:text-violet-300">
